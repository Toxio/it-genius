...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center ">
      <h1 className="text-xl font-bold text-center my-14 md:tracking-[40px] font-[Jaden]">
        Anton Khomenko
      </h1>
      ...
      <div className="flex flex-col md:flex-row mx-2">
        ...
        <div className="bg-[#7E7A71] md:ml-1.5 rounded-lg w-[49vw] h-fit">
      ...
      <div className="flex flex-col md:flex-row mt-1.5 mx-2">
        ...
        <div className="bg-[#c4c3b9] md:ml-1.5 rounded-lg w-[49vw] h-fit mx-auto relative mt-1.5 md:mt-0">
          <p className="absolute left-8 top-4 z-10 w-[19rem] text-xs hidden md:block">
